...
RESOURCES += src/qt/boa.qrc src/qt/boa_locale.qrc
TRANSLATIONS += src/qt/locale/boa_bg.ts \
                src/qt/locale/boa_de.ts \
                src/qt/locale/boa_en.ts \
                src/qt/locale/boa_es.ts \
                src/qt/locale/boa_fi.ts \
                src/qt/locale/boa_fr.ts \
                src/qt/locale/boa_it.ts \
                src/qt/locale/boa_ja.ts \
                src/qt/locale/boa_pl.ts \
                src/qt/locale/boa_pt.ts \
                src/qt/locale/boa_ru.ts \
                src/qt/locale/boa_sk.ts \
                src/qt/locale/boa_sv.ts \
                src/qt/locale/boa_vi.ts \
                src/qt/locale/boa_zh_CN.ts \
                src/qt/locale/boa_zh_TW.ts
