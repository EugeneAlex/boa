...
Development
---------------------
The Dash repo's [root README](https://github.com/EugeneAlex/boa/blob/master/README.md) contains relevant information on the development process and automated testing.
