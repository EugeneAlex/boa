...
Only requiring some minor changes is boa.cpp.
...
Changes to boa.cpp
----------------------
boa.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
