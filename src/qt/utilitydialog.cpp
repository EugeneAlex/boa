    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Boa Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Boa Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  boa-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Boa Core is shutting down...") + "<br /><br />" +
