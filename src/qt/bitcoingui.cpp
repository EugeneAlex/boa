    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Boa Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Boa address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and boa: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Boa Core"), this);
    aboutAction->setStatusTip(tr("Show information about Boa Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Boa"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Boa addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Boa addresses"));
    ...
    openAction->setStatusTip(tr("Open a boa: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Boa Core help message to get a list with possible Boa command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Boa Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Boa network", "", count));
}
...
{
    QString strTitle = tr("Boa Core"); // default title
