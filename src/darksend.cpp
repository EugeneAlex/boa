...
/* *** BEGIN DARKSEND MAGIC - BOA **********
    Copyright (c) 2014-2015, Boa Developers
        eduffield - evan@boapay.io
        udjinm6   - udjinm6@boapay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Boa and make it unusable. To
