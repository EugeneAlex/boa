...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Boa features */
    { "boa",               "masternode",             &masternode,             true,      true,       false },
    { "boa",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "boa",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "boa",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "boa",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "boa",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "boa",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "boa",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "boa",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use boad, or the -server option to boa-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> boa-cli " + methodname + " " + args + "\n";
}
